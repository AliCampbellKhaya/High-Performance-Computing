// kenneth.roche@pnl.gov; k8r@uw.edu ; kenroche@amd.com
// az=b 
// input: dim(a)
...
//#include <mkl_pblas.h>
//
//for Hyak - just remove the header and add prototype
//#include <scalapack.h>
...
/* Map C names used below to Fortran ScaLAPACK symbol names */
#define pzgesv pzgesv_
#define pzgemv pzgemv_
